...
class Transaksi_model extends CI_Model
{
	...
	public function checkNoFakturExists($no_faktur)
	{
		...
		$query = $this->db->get('data_transaksi'); // Gantilah 'nama_tabel_transaksi' dengan nama tabel transaksi Anda
	...
	public function cariDataPPN($search)
	{
		...
		if ($search === null) {
			...
			$query = $this->db->get('data_transaksi'); // Gantilah 'nama_tabel' sesuai dengan tabel yang sesuai
		} else {
