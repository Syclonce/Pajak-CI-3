 ...
 <div class="container-fluid">
     ...
     <div class="card">
         ...
         <div class="card-body">
             ...
             <form class="form-inline" action="<?= base_url('PPH22'); ?>" method="GET">
                 ...
                 <?php if (!empty($search)) { ?>
                     <a href="<?= base_url('PPH22/cetakLaporanscr?search=' . urlencode($search) . '&tanggal_mulai=' . '&tanggal_selesai='); ?>" class="btn btn-success mb-2 ml-3"><i class="fas fa-print"></i> Cetak Laporan</a>
                 <?php } elseif (!empty($startDay) && !empty($endDay)) { ?>
                     <a href="<?= base_url('PPH22/cetakLaporan?search=' . '&tanggal_mulai=' . $startDay . '&tanggal_selesai=' . $endDay); ?>" class="btn btn-success mb-2 ml-3"><i class="fas fa-print"></i> Cetak Laporan</a>
                 <?php } else { ?>
        ...
        if ($jml_data > 0) { ?>
         ...
         <table class="table table-bordered table striped">
             <tr>
                 ...
                 <th class="text-center">PPH 22 (3%)</th>
                 <th class="text-center">PPH 22 (1,5%)</th>
             ...
             <?php $no = 1;
                foreach ($ppn as $t) : ?>
                 ...
                 <tr>
                     ...
                     <td>
                         <center>Rp. <?= number_format($t->pph, 0, ',', '.') ?></center>
                     </td>
                     <td>
                         <center>Rp. <?= number_format($t->npwp, 0, ',', '.') ?></center>
                     </td>
                     <td>
                         <center>Rp. <?= number_format($t->pph + $t->harga + $t->npwp, 0, ',', '.') ?></center>
                     </td>
